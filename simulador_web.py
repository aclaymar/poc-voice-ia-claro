...
if st.session_state.call_state == "idle":
    ...
    <style>
    /*
     * Botão Ligar — posicionamento absoluto dentro do .block-container
     * (que já tem position:relative). Isso garante centralização
     * independente de qualquer wrapper gerado pelo Streamlit.
     */
